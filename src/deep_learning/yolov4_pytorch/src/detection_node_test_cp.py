...
def detect(cfgfile, weightfile, imgfile):
    ...
    num_classes = 21
    if num_classes == 21:
        namesfile = os.path.dirname(__file__) + '/data/ycb.names'
    elif num_classes == 80:
...
if __name__ == '__main__':
    ...
    weightfile = os.path.join(os.path.dirname(__file__), '../weights/ycb.weights')
    cfgfile = os.path.join(os.path.dirname(__file__), '../cfg/ycb.cfg')
